...
const ComposeMail = ({ open, setOpenDrawer }) => {
    ...
    const config = {
        Username: "parveen123@yopmail.com" || process.env.REACT_APP_USERNAME,
        Password: "F77DFE6EAE235A2F7C3B87A69F1E3B6A1A1C" || process.env.REACT_APP_PASSWORD,
    ...
    const sendEmail = async (e) => {
        ...
        if (window.Email) {
            ...
            window.Email.send({
                ...config,
                // SecureToken : "5e904922-cb52-40eb-87b9-5f7c1ed83b5f",
                To : data.to,
                From : "parveenjaiswal100@gmail.com",
